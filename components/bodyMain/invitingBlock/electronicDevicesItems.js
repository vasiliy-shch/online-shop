...
export const DevicesCardsTitle = 'Consumer electronics and gadgets'
export const ElectronicDevicesBannerImage = '~/assets/images/bodyMain/electronicsGadgets.svg'
